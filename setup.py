...
setup(
    ...
    packages=['thingsboard_gateway', 'thingsboard_gateway.gateway', 'thingsboard_gateway.gateway.proto',
              ...
              #'thingsboard_gateway.connectors.opcua_asyncio',
              'thingsboard_gateway.connectors.xmpp',
              #'thingsboard_gateway.connectors.opcua',
              'thingsboard_gateway.connectors.request', 'thingsboard_gateway.connectors.ocpp',
              ...
              'thingsboard_gateway.extensions.mqtt', 'thingsboard_gateway.extensions.modbus',
